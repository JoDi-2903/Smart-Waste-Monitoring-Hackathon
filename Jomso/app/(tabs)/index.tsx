...
export default function HomeScreen() {
  ...
  const renderPaginationDots = () => {
    const totalPages = Math.ceil(enhancedRewards.length / 2); // 2 visible items per page
    return (
    ...
    <View
      ...
      <View style={styles.ctaSection}>
        ...
        <Text style={styles.ctaDescription}>
          Glass recycling reduces landfill waste by 100% and saves energy. Find
          a container near you and start earning points!
        </Text>
      </View>
