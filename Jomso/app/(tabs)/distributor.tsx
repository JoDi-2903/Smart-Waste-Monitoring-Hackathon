...
export default function RouteOptimizationScreen() {
  ...
  return (
    <ScrollView style={[styles.container, { paddingTop: insets.top }]}>
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          {isCalculating ? (
            ...
            <Ionicons name='refresh' size={22} color={colors.bg_dark} />
          )}
        </TouchableOpacity>
      </View>
      ...
      {optimizedRoute && (
        <View style={styles.routeSummary}>
          <View style={styles.summaryItem}>
            <Ionicons name='navigate' size={22} color={colors.bg_dark} />
          ...
          <View style={styles.summaryItem}>
            <Ionicons name='time' size={22} color={colors.bg_dark} />
            <Text style={styles.summaryValue}>
          ...
          <View style={styles.summaryItem}>
            <Ionicons name='trash' size={22} color={colors.bg_dark} />
            <Text style={styles.summaryValue}>
              {optimizedRoute.binsToCollect}
            </Text>
            <Text style={styles.summaryLabel}>Bins</Text>
          </View>
          <View style={styles.summaryItem}>
            <Ionicons name='leaf' size={22} color={colors.bg_dark} />
            <Text style={styles.summaryValue}>
      ...
      <View style={styles.binsContainer}>
        {mockBins.map((bin) => (
          <View key={bin.id} style={styles.binItem}>
            <View
              style={[styles.priorityIndicator, { backgroundColor: fillColor }]}
            />
            ...
            <View style={styles.fillLevelContainer}>
              <Text style={[styles.fillLevelText, { color: colors.bg_dark }]}>
                {bin.fillLevel}%
              </Text>
      ...
      <TouchableOpacity
        style={[styles.startButton, { backgroundColor: fillColor }]}>
        <Ionicons
