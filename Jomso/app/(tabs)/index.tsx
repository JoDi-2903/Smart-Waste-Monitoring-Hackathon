...
export default function HomeScreen() {
  ...
  <View style={{ flexDirection: "row", alignItems: "center" }}>
    ...
    <View style={{ marginLeft: 12 }}>
      ...
      <Text style={styles.rankSubtext}>Keep going to unlock theater tickets!</Text>
    </View>
  </View>
</View>
...
<View style={styles.rewardsGrid}>
  {rewards.map((reward, index) => (
    <View key={reward.id} style={styles.rewardItemGrid}>
      ...
      <Text style={{ marginTop: 6, fontSize: 12, textAlign: "center" }}>{reward.label}</Text>
    </View>
  ))}
</View>
<TouchableOpacity
...
>
  <Ionicons name="location-sharp" size={20} color="#111827" style={{ marginRight: 8 }} />
  <Text style={styles.exploreButtonText}>Find Nearby Empty Glass Containers</Text>
</TouchableOpacity>
  </ScrollView>
  );
}
