...
with_node \
  ...
  --target "/Users/shaharyarnawaz/mygit/Jomso/Jomso/ios/Pods/Target Support Files/Pods-Jomso/ExpoModulesProvider.swift" \
  --entitlement "/Users/shaharyarnawaz/mygit/Jomso/Jomso/ios/Jomso/Jomso.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-eas-client" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-location" "expo-media-library" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-updates" "expo-web-browser"
